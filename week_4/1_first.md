...
In this challenge, you are going to make a method that takes an array of names and outputs a list of accountability groups for three different units. You should try to get everyone into an accountability group of 4, but it's your decision how to deal with cohorts not easily divisible by four. 

You should refer to the [Ruby Docs](http://ruby-doc.org/) often to think of ways you can do this. 
